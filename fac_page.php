	...
	<!--	<div id="TT">
		...
		<form method="post" action="fac_msg.php" style="padding-top: 7px;">
			<fieldset id="msg2" disabled style="width: 35%;">
				<textarea rows="6" cols="40" name="Message" style="padding: 3px;border-radius: 10px;"></textarea><br>
				<input type="submit" name="submit">
			</fieldset>
		</form>
				...
				if($res3>0)
				{
					while($row2=$sel3->fetch_assoc())
					{
						...
						echo('<ul style="list-style-type: disc">
								<li>'. $row2["Task"] . ' <br>On '.$day. ',' . $date3 . ' at ' . $row2["Alloted_time"] . '<br>Message: '. $row2["Message"] .'</li></ul>');
					}
				}
			?>
		</div>
